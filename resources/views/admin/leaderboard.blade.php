            ...
            <table class="w-full text-left">
                <thead>
                    <tr class="border-b border-[#c0c9bb] bg-[#F1F8E9]">
                        ...
                        <th class="px-6 py-3 text-xs font-semibold text-[#717a6d] uppercase tracking-wider w-32">Status</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr class="border-b border-[#e5e2e1] hover:bg-[#f6f3f2] transition-colors">
                        <td class="px-6 py-3 text-center font-bold {{ $i === 0 ? 'text-[#00450d]' : 'text-[#717a6d]' }}">
                            {{ $item['rank'] }}
                        </td>
                        <td class="px-6 py-3">
                            <div class="flex items-center gap-3">
                                <div class="w-8 h-8 rounded-full bg-[#1b5e20]/10 border border-[#c0c9bb] flex items-center justify-center font-semibold text-[#1b5e20] text-xs flex-shrink-0">

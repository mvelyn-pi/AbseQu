<x-app-layout>
    ...
    <div class="max-w-3xl mx-auto space-y-lg">
        ...
        <div class="flex items-center gap-md mb-xl">
            ...
            <div>
                <h2 class="font-headline-lg text-headline-lg text-on-surface">Tambah Kelas Baru</h2>
                <p class="font-body-sm text-on-surface-variant">Isi form di bawah untuk mendaftarkan kelas baru.</p>
            </div>
        </div>
        ...
        <div class="bg-surface border border-outline-variant rounded-xl overflow-hidden">
            ...
            <form action="{{ route('admin.kelas.store') }}" method="POST" class="p-lg md:p-xl space-y-lg">
                @csrf
                
                <div class="grid grid-cols-1 md:grid-cols-2 gap-lg">
                    <div class="flex flex-col gap-base">
                        <label class="font-label-bold text-label-bold text-on-surface-variant uppercase" for="nama_kelas">Nama Kelas (mis: MIPA 1)</label>
                        <input type="text" name="nama_kelas" id="nama_kelas" value="{{ old('nama_kelas') }}" required class="border border-outline-variant rounded-lg px-md py-sm font-body-lg text-body-lg focus:ring-1 focus:ring-primary focus:border-primary outline-none bg-surface-container-lowest">
                    </div>
                    ...
                    <div class="flex flex-col gap-base">
                        <label class="font-label-bold text-label-bold text-on-surface-variant uppercase" for="wali_kelas_id">Wali Kelas (Opsional)</label>
                    ...
                    <div class="flex flex-col gap-base">
                        ...
                        <input type="number" name="tahun_ajaran" id="tahun_ajaran" value="{{ old('tahun_ajaran', date('Y')) }}" required min="2020" max="2050" class="border border-outline-variant rounded-lg px-md py-sm font-body-lg text-body-lg focus:ring-1 focus:ring-primary focus:border-primary outline-none bg-surface-container-lowest">
                    </div>
                </div>

<x-app-layout>
    <x-slot name="title">Tambah Orang Tua</x-slot>
    ...
    <div class="max-w-3xl mx-auto space-y-lg">
        ...
        <div class="flex items-center gap-md mb-xl">
            ...
            <div>
                <h2 class="font-headline-lg text-headline-lg text-on-surface">Tambah Orang Tua Baru</h2>
                <p class="font-body-sm text-on-surface-variant">Daftarkan akun untuk wali murid / orang tua.</p>
            </div>
        </div>
        ...
        <div class="bg-surface border border-outline-variant rounded-xl overflow-hidden">
            ...
            <form action="{{ route('admin.orangtua.store') }}" method="POST" class="p-lg md:p-xl space-y-lg">
                @csrf

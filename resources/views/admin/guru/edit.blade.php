<x-app-layout>
    ...
    <div class="max-w-3xl mx-auto space-y-lg">
        ...
        <div class="flex items-center gap-md mb-xl">
            ...
            <div>
                <h2 class="font-headline-lg text-headline-lg text-on-surface">Edit Data Guru</h2>
                <p class="font-body-sm text-on-surface-variant">Ubah informasi profil guru. Kosongkan password jika tidak ingin mengubahnya.</p>
            </div>
        </div>
        ...
        <div class="bg-surface border border-outline-variant rounded-xl overflow-hidden">
            ...
            <form action="{{ route('admin.guru.update', $guru) }}" method="POST" class="p-lg md:p-xl space-y-lg">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-lg">
                    <div class="flex flex-col gap-base">
                        ...
                        <input type="text" name="nama" id="nama" value="{{ old('nama', $guru->nama) }}" required class="border border-outline-variant rounded-lg px-md py-sm font-body-lg text-body-lg focus:ring-1 focus:ring-primary focus:border-primary outline-none bg-surface-container-lowest">
                    </div>

                    <div class="flex flex-col gap-base">
                        <label class="font-label-bold text-label-bold text-on-surface-variant uppercase" for="no_whatsapp">Nomor WhatsApp</label>
                        <input type="text" name="no_whatsapp" id="no_whatsapp" value="{{ old('no_whatsapp', $guru->no_whatsapp) }}" class="border border-outline-variant rounded-lg px-md py-sm font-body-lg text-body-lg focus:ring-1 focus:ring-primary focus:border-primary outline-none bg-surface-container-lowest" placeholder="08123456789">
                    </div>
                    ...
                    <div class="flex flex-col gap-base md:col-span-2">
                        ...
                        <input type="email" name="email" id="email" value="{{ old('email', $guru->email) }}" required class="border border-outline-variant rounded-lg px-md py-sm font-body-lg text-body-lg focus:ring-1 focus:ring-primary focus:border-primary outline-none bg-surface-container-lowest">
                    </div>
